                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="authsign" method="post">
								@csrf
                                ...
                                <div class="form-group">
                                    <label>Name</label>
                                    <input class="au-input au-input--full" type="text" name="name" placeholder="Full Name" required>
                                </div>
                                <div class="form-group">
                                    <label>Process</label>
                                    <select class="au-input au-input--full" type="text" name="process" required>
                                        @foreach($pname as $list)
                                        <option value="{{$list->Process_Id;}}">{{$list->Process_Name;}}</option>
                                        @endforeach
                                    </select>
                                </div>
